...
class Generator:
    ...
    def __post_init__(self):
        ...
        self.image_name = "rockylinux-volatility"
        self.volatility_builder_path = "/tmp/volatility/tools/linux"
        self.container_name = f"rockylinux-volatility-{self.kernel}"
        self.container_obj = Container(
            self.image_name,
            self.container_name,
            get_project_base_path() / "RockyLinux/Dockerfile-rockylinux",
        )
...
@click.option(
    ...
    "--kernel",
    type=str,
    help="RockyLinux kernel to generate profile against (ex: 4.18.0-477.10.1.el8_8.x86_64)",
    required=True,
)
@click.option(
    "-o",
